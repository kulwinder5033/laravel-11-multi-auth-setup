...
@section('title', 'Add Donor | Superadmin')
@section('content')
                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">Add Donor</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="row g-5 gx-xl-10 mb-5 mb-xl-10">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-md-12 mb-xl-12">
                            <div class="card">
                                <!--begin::Header-->
                                <div class="card-body">
                                    <form id="accountForm" method="POST" action="{{ route('superadmin.donors.store') }}"
                                        ...
                                        <div class="fv-row mb-2 fv-plugins-icon-container">
                                            ...
                                            <input type="date" class="form-control" id="donation_date" name="donation_date"
                                                placeholder="Enter donation_date" value="">
                                            @error('donation_date')
                                                <div
                                                    class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                                    <div data-field="text_input" data-validator="notEmpty">{{ $message }}
